...
class VulnscanManager(object):
    ...
    def launch_scan(self, target, **kwargs):
        ...
        try:
            ...
            raise VulnscanScanError(
                "Unknown error while try to start the my_scanner '%s'. Error: %s" % (m_task_id, e.message))
    ...
    def get_results(self, task_id):
        ...
        try:
            ...
            raise VulnscanServerError("Can't get the results for the my_scanner %s. Error: %s" % (task_id, e.message))
    ...
    def _callback(self, func_end, func_status):
        ...
        :param func_end: Function called when my_scanner end.
        :type func_end: funtion pointer

        :param func_status: Function called for update my_scanner status.
